...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_BATTLE_PAY_ACK_FAILED_RESPONSE,                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayAckFailed);
    DEFINE_HANDLER(CMSG_BATTLE_PAY_CANCEL_OPEN_CHECKOUT,                    STATUS_IGNORED,   PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
    DEFINE_HANDLER(CMSG_BATTLE_PAY_CONFIRM_PURCHASE_RESPONSE,               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayConfirmPurchase);
    ...
    DEFINE_HANDLER(CMSG_BATTLE_PAY_START_PURCHASE,                          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayStartPurchase);
    ...
    DEFINE_HANDLER(CMSG_CATALOG_SHOP_LICENSE_GAME_DATA_REQUEST,             STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayCatalogShopLicenseGameDataRequest);
    DEFINE_HANDLER(CMSG_CHALLENGE_MODE_REQUEST_LEADERS,                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChallengeModeRequestLeaders);
    ...
    DEFINE_HANDLER(CMSG_COMMERCE_TOKEN_GET_MARKET_PRICE,                    STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayCommerceTokenGetMarketPrice);
    ...
    DEFINE_HANDLER(CMSG_CONSUMABLE_TOKEN_CAN_VETERAN_BUY,                   STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayConsumableTokenCanVeteranBuy);
    ...
    DEFINE_HANDLER(CMSG_GET_ALL_LICENSED_DECOR_QUANTITIES,                  STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayGetAllLicensedDecorQuantities);
    ...
    DEFINE_HANDLER(CMSG_GET_DECOR_REFUND_LIST,                              STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayGetDecorRefundList);
    ...
    DEFINE_HANDLER(CMSG_GET_LAST_CATALOG_FETCH,                             STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayGetLastCatalogFetch);
    ...
    DEFINE_HANDLER(CMSG_MYTHIC_PLUS_REQUEST_MAP_STATS,                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMythicPlusRequestMapStats);
    ...
    DEFINE_HANDLER(CMSG_REQUEST_MYTHIC_PLUS_AFFIXES,                        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRequestMythicPlusAffixes);
    DEFINE_HANDLER(CMSG_REQUEST_MYTHIC_PLUS_SEASON_DATA,                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRequestMythicPlusSeasonData);
    ...
    DEFINE_HANDLER(CMSG_REQUEST_STORE_FRONT_INFO_UPDATE,                    STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayRequestStoreFrontInfoUpdate);
    ...
    DEFINE_HANDLER(CMSG_UPDATE_LAST_CATALOG_FETCH,                          STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayUpdateLastCatalogFetch);
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLE_PAY_DELIVERABLE_DELIVERED,                             STATUS_NEVER,       CONNECTION_TYPE_REALM);
